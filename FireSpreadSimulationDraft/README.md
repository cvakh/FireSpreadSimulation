...
```
javac -d out src/cells/*.java src/model/*.java src/gui/*.java src/main/*.java
```

### 2. Run text version (console output, good for testing)
```
java -cp out main.FireSimulation
```

### 3. Run GUI version (animated window)
```
java -cp out gui.FireSimulationGUI
```
...
## 🌡️ Simulation Parameters (edit in FireWorld.java or FireSimulationGUI.java)
